...
if( function_exists( '_mc4wp_load_plugin' ) ){
    ...
    $wp_customize->add_setting('enable_subscribe',
        array(
            'default' => $reminiscence_lite_default['enable_subscribe'],
            'capability' => 'edit_theme_options',
    ...
    $wp_customize->add_control('enable_subscribe',
        array(
            'label' => esc_html__('Enable Newsletter Subscription Section', 'reminiscence-lite'),
    ...
    $wp_customize->add_setting('subscribe_section_title',
        array(
            'default' => $reminiscence_lite_default['subscribe_section_title'],
            'capability' => 'edit_theme_options',
    ...
    $wp_customize->add_control('subscribe_section_title',
        array(
            'label' => esc_html__('Newsletter Subscription Section Title', 'reminiscence-lite'),
            'section' => 'subscribe_section',
            'type' => 'text',
        )
    );
    ...
    $wp_customize->add_setting('subscribe_section_desc',
        array(
            'default' => $reminiscence_lite_default['subscribe_section_desc'],
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
        )
    );
    ...
    $wp_customize->add_control('subscribe_shortcode',
        array(
            'label' => esc_html__('Newsletter Subscription Form Shortcode', 'reminiscence-lite'),
            'section' => 'subscribe_section',
            'type' => 'textarea',
        )
    );
    ...
    $wp_customize->add_setting('ed_popup_model_box',
        array(
            'default' => $reminiscence_lite_default['ed_popup_model_box'],
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'reminiscence_lite_sanitize_checkbox',
        )
    );
    $wp_customize->add_control('ed_popup_model_box',
        array(
            'label' => esc_html__('Enable Newsletter popup', 'reminiscence-lite'),
            'section' => 'subscribe_section',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_setting('ed_popup_model_box_home_only',
        array(
            'default' => $reminiscence_lite_default['ed_popup_model_box_home_only'],
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'reminiscence_lite_sanitize_checkbox',
        )
    );
    $wp_customize->add_control('ed_popup_model_box_home_only',
        array(
            'label' => esc_html__('Prompt only on homepage', 'reminiscence-lite'),
            'section' => 'subscribe_section',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_setting('ed_popup_model_box_first_loading_only',
        array(
            'default' => $reminiscence_lite_default['ed_popup_model_box_first_loading_only'],
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'reminiscence_lite_sanitize_checkbox',
        )
    );
    $wp_customize->add_control('ed_popup_model_box_first_loading_only',
        array(
            'label' => esc_html__('Do not show this again this session', 'reminiscence-lite'),
            'section' => 'subscribe_section',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control(
        ...
        'wedev_popup_bg_image_image',
            array(
                'label'      => esc_html__( 'Popup Model Box Image', 'reminiscence-lite' ),
                'section'    => 'subscribe_section',
            )
        )
    );
    ...
    $wp_customize->add_setting( 'wedev_popup_title',
        array(
        'default'           => $reminiscence_lite_default['wedev_popup_title'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        )
    );
    $wp_customize->add_control( 'wedev_popup_title',
        array(
        'label'    => esc_html__( 'Popup Model Box Title', 'reminiscence-lite' ),
        'section'  => 'subscribe_section',
        'type'     => 'text',
        )
    );
    ...
    $wp_customize->add_setting( 'wedev_popup_desc',
        array(
        'default'           => $reminiscence_lite_default['wedev_popup_desc'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        )
    );
    $wp_customize->add_control( 'wedev_popup_desc',
        array(
        'label'    => esc_html__( 'Popup Model Box Description', 'reminiscence-lite' ),
        'section'  => 'subscribe_section',
        'type'     => 'text',
        )
    );
    ...
    $wp_customize->add_control( 'wedev_form_shortcode',
        array(
        'label'    => esc_html__( 'Shortcode', 'reminiscence-lite' ),
        'section'  => 'subscribe_section',
        'type'     => 'textarea',
        )
    );
    ...
    $wp_customize->add_setting(
        'reminiscence_lite_mcfwp_plugin',
        array(
            'default'           => '',
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control(
        new Reminiscence_Lite_Plugin_Link( 
            $wp_customize,
            'reminiscence_lite_mcfwp_plugin',
            array(
                'label'      => esc_html__( 'Please install and activate "MC4WP: Mailchimp for WordPress" in order to use this feature.', 'reminiscence-lite' ),
                'settings' => 'reminiscence_lite_mcfwp_plugin',
                'section'       => 'subscribe_section',
            )
        )
    );
