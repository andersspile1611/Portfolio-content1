...
if( !function_exists( 'reminiscence_lite_subscribe' ) ) :

    //Google Fonts URL
    function reminiscence_lite_subscribe(){

        $reminiscence_lite_default = reminiscence_lite_get_default_theme_options();
        $enable_subscribe = get_theme_mod( 'enable_subscribe', $reminiscence_lite_default['enable_subscribe'] );
        $subscribe_shortcode = get_theme_mod( 'subscribe_shortcode' );
        $subscribe_section_title = get_theme_mod( 'subscribe_section_title', $reminiscence_lite_default['subscribe_section_title'] );
        $subscribe_section_desc = get_theme_mod( 'subscribe_section_desc', $reminiscence_lite_default['subscribe_section_desc'] );
...
add_action('reminiscence_lite_bottom_content','reminiscence_lite_subscribe',10);

if( !function_exists('reminiscence_lite_popup_model_box') ):

    function reminiscence_lite_popup_model_box(){

        $reminiscence_lite_default = reminiscence_lite_get_default_theme_options();
        $ed_popup_model_box = get_theme_mod( 'ed_popup_model_box',$reminiscence_lite_default['ed_popup_model_box'] );
        $ed_popup_model_box_first_loading_only = get_theme_mod( 'ed_popup_model_box_first_loading_only',$reminiscence_lite_default['ed_popup_model_box_first_loading_only'] );
        ...
        if( $visited && $ed_popup_model_box ){
            ...
            $ed_popup_model_box_home_only = get_theme_mod( 'ed_popup_model_box_home_only',$reminiscence_lite_default['ed_popup_model_box_home_only'] );
            $wedev_form_shortcode = get_theme_mod( 'wedev_form_shortcode' );
            $wedev_popup_title = get_theme_mod( 'wedev_popup_title',$reminiscence_lite_default['wedev_popup_title'] );
            $wedev_popup_desc = get_theme_mod( 'wedev_popup_desc',$reminiscence_lite_default['wedev_popup_desc'] );
...
add_action( 'reminiscence_lite_bottom_content','reminiscence_lite_popup_model_box',30 );