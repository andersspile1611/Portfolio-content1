...
if( !function_exists('reminiscence_lite_custom_taxonomy_field') ):

	// Add term page
    function reminiscence_lite_custom_taxonomy_field(){
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Feature Image', 'reminiscence-lite'); ?></label>
...
add_action('category_add_form_fields', 'reminiscence_lite_custom_taxonomy_field', 10, 2);


if( !function_exists('reminiscence_lite_taxonomy_edit_meta_field') ):

	// Edit term page
    function reminiscence_lite_taxonomy_edit_meta_field($term){

        $wedev_term_image = get_term_meta( $term->term_id, 'wedevs-term-featured-image', true ); ?>
        <tr>
            
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'reminiscence-lite'); ?></label></th>
...
add_action('category_edit_form_fields', 'reminiscence_lite_taxonomy_edit_meta_field', 10, 2);
