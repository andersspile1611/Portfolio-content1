    ...
    <div class="site-header-area site-header-top">
        <div class="site-header-components header-components-left">
            <div class="header-component-item">
                <div class="site-branding">
                    ...
                    $reminiscence_lite_description = get_bloginfo('description', 'display');
                    if ($reminiscence_lite_description || is_customize_preview()) :
                        ?>
                        <p itemprop="description" class="site-description">
                            <span><?php echo $reminiscence_lite_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                ?></span>
                        </p>
                    <?php endif; ?>
                    </div>
        ...
        <div class="site-header-components header-components-right">
            ...
            <div class="header-component-item hidden-md-screen">
                <nav class="primary-menu-wrapper" aria-label="<?php esc_attr_e('Horizontal', 'reminiscence-lite'); ?>" role="navigation" itemscope itemtype="https://schema.org/SiteNavigationElement">
            ...
            $enable_header_search = get_theme_mod('enable_header_search', $reminiscence_lite_default['enable_header_search']);
            ...
            if ($enable_header_search) { ?>
                <div class="header-component-item header-wedevs-search">
                    <button class="toggle search-toggle mobile-search-toggle" data-toggle-target=".search-modal"
                            ...
                            aria-expanded="false">
                        <?php reminiscence_lite_get_theme_svg('search'); ?>
                    </button>
                </div>
            <?php } ?>
            ...
            <div class="header-component-item header-wedevs-menu">
                <button class="toggle nav-toggle mobile-nav-toggle" data-toggle-target=".menu-modal" data-toggle-body-class="showing-menu-modal" aria-expanded="false" data-set-focus=".close-nav-toggle">
                    <?php reminiscence_lite_get_theme_svg('menu'); ?>
                </button>
            </div>
        </div>
