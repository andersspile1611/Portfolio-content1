...
<div class="wedevs-post-wrapper">
            ...
            <div class="site-row">
                <div class="site-column site-column-3 site-column-sm-12">
                    <?php if ('post' === get_post_type()) : ?>
                        ...
                        <div class="entry-meta">
                            <?php reminiscence_lite_posted_by($c_title = true, $image = true); ?>
                        </div>
                        <div class="entry-meta">
                        ...
                        <?php if (!is_singular()) : ?>
                            <div class="wedevs-continue-reading">
                                <a href="<?php the_permalink(); ?>" class="wedevs-btn wedevs-btn-primary">
                                    <?php esc_html_e('Continue Reading', 'reminiscence-lite'); ?>
                                    <span class="wedevs-btn-icon"><?php reminiscence_lite_get_theme_svg('chevron-right'); ?></span>
                                </a>
                            </div>
                        <?php endif; ?>
                            ...
                            if (!is_single() && !post_password_required() && (comments_open() || get_comments_number())) {
                                ...
                                <div class="comment-link">
                                    <a href="<?php echo esc_url($comment_url); ?>">
                                        <span><?php reminiscence_lite_get_theme_svg('comment'); ?></span>
                                        <span><?php echo absint($comment_count) . esc_html__(' Comments', 'reminiscence-lite'); ?></span>
                                    </a>
                                </div>
    ...
    <?php if (!is_search()) {
        reminiscence_lite_archive_recommended_posts();
    } ?>
