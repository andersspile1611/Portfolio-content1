...
jQuery(document).ready(function($) {
  ...
  $("#_customize-input-wedev_general_font").selectize();
    ...
    jQuery('#_customize-input-wedev_general_font').on('change',function(){
        ...
        var family = $(this).val();
        var ajaxurl = reminiscence_lite_customizer.ajax_url;
        var data = {
            'action': 'reminiscence_lite_fonts_ajax',
            'family': family,
        };
  ...
  $("#_customize-input-wedev_heading_font").selectize();
    ...
    jQuery('#_customize-input-wedev_heading_font').on('change',function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            select = $('#_customize-input-reminiscence_lite_h1_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h1_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );

            select = $('#_customize-input-reminiscence_lite_h2_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h2_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );

            select = $('#_customize-input-reminiscence_lite_h3_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h3_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );

            select = $('#_customize-input-reminiscence_lite_h4_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h4_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );

            select = $('#_customize-input-reminiscence_lite_h5_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h5_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );

            select = $('#_customize-input-reminiscence_lite_h6_font_weight');
            select.empty().append(response);
             wp.customize( 'reminiscence_lite_h6_font_weight', function ( obj ) {
                obj.set( 'regular' );
            } );
  ...
  $("#_customize-input-wedev_tagline_font").selectize();
    ...
    // Save Value.
    function reminiscence_lite_refresh_repeater_values(){

        $(".reminiscence-lite-repeater-field-control-wrap").each(function(){
            ...
            current.next('.reminiscence-lite-repeater-collector').val( JSON.stringify( values ) ).trigger('change');
        });

    }

    $("body").on("click",'.reminiscence-lite-add-control-field', function(){
        ...
        if(typeof current != 'undefined') {
            ...
            if(typeof field != 'undefined'){
                ...
                field.find('.reminiscence-lite-fields').show();

                current.find('.reminiscence-lite-repeater-field-control-wrap').append(field);
                $('.accordion-section-content').animate({ scrollTop: current.height() }, 1000);
                reminiscence_lite_refresh_repeater_values();
            }

            $('.reminiscence-lite-repeater-field-control-wrap li').removeClass('wedevs-sortable-active');
            $('.reminiscence-lite-repeater-field-control-wrap li:last-child').addClass('wedevs-sortable-active');
            $('.reminiscence-lite-repeater-field-control-wrap li:last-child .reminiscence-lite-repeater-fields').addClass('wedevs-sortable-active extended');
            $('.reminiscence-lite-repeater-field-control-wrap li:last-child .reminiscence-lite-repeater-fields').show();

            $('.wedevs-repeater-wrap.wedevs-sortable-active .title-rep-wrap').click(function(){
                $(this).next('.reminiscence-lite-repeater-fields').slideToggle().toggleClass('extended');
            }); 

            $('.reminiscence-lite-repeater-field-control-wrap li:last-child .wedevs-header-title').text('Social Profile');
    ...
    $("#customize-theme-controls").on("click", ".reminiscence-lite-repeater-field-remove",function(){
    ...
    $('#customize-theme-controls').on('click', '.reminiscence-lite-repeater-field-close', function(){
        $(this).closest('.reminiscence-lite-repeater-fields').slideUp();
        $(this).closest('.wedevs-repeater-wrap').toggleClass('expanded');
    });

    /*Drag and drop to change order*/
    $(".reminiscence-lite-repeater-field-control-wrap").sortable({
        axis: 'y',
