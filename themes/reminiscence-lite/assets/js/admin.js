(function ($) {
  ...
  var ajaxurl = reminiscence_lite_admin.ajax_url;
  var ajaxNonce = reminiscence_lite_admin.ajax_nonce;

  $('.wedevs-dismiss-notice').click(function(){
    
    var currentElement = $(this);
    var data = {
          'action': 'reminiscence_lite_about_notice_dismiss',
          '_wpnonce': ajaxNonce,
      };
  ...
  // Image Upload
    ...
    frame = wp.media({
        title: reminiscence_lite_admin.title,
        button: {
        text: reminiscence_lite_admin.label
        },
  ...
  $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        var data = {
            ...
            'action': 'reminiscence_lite_install_plugins',
            '_wpnonce': ajaxNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {
            
            var active = reminiscence_lite_admin.active
            var deactivate = reminiscence_lite_admin.deactivate
